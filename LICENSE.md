Lecithin inherits its licensing from the included upstream projects.

Lecithin从上游继承了许可证。

As such, Lecithin is licensed under the
...
因此，Lecithin中应当遵守[GNU通用公共许可证-第3版](licenses/GPL.md)；
因为Lecithin从上游Lophine继承了它，而Lophine又从其上游的Folia、Paper、Spigot、Bukkit和Craftbukkit项目中继承了它。
