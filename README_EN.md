<div align="center">
  ...
  *Lecithin is a Lophine fork with many useful optimizations and configurable vanilla features, aims to *
...
### Stable Releases
All release versions can be found on the [Releases](https://github.com/LophineLabs/Lecithin/releases) page.
...
After building, you can find the generated JAR file in the `lecithin-server/build/libs` directory.
...
- 📋 [Submit Issues](https://github.com/LophineLabs/Lecithin/issues)
